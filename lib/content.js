...
export const FOUNDERS = [
  {
    ...
    // Section headline as [lead, highlighted] — the highlighted part renders in teal.
    tagline: ['Building with', 'purpose.'],
    summary: 'I’m building Fenbrix to help businesses turn ideas into practical digital products, technology and digital solutions — with clarity, creativity and long-term thinking.',
    role: 'Founder — Fenbrix',
    focus: ['Product', 'Technology', 'Digital'],
    location: 'Noida',
    image: '/Ashish.png',
    description: 'I’m building Fenbrix to help businesses turn ideas into practical digital products and technology that create meaningful impact.',
    intro: "Fenbrix is a dream I'm building from the ground up.",
    // Each paragraph is a list of [text, emphasis] segments — emphasis is
    // null (plain), 'bold' or 'teal' — so Founders.jsx can render the
    // highlighted keywords without embedding JSX/markup in the content data.
    // Highlighting stays deliberately sparse — a handful of keywords, not
    // every phrase — so the story still reads as prose, not a keyword list.
    bio: [
      [
        ["I'm a technology professional with hands-on experience across ", null],
        ['web development', 'bold'],
        [', ', null],
        ['React.js', 'bold'],
        [', digital products, content creation, social media, community building, branding and technology-driven projects.', null],
      ],
      [
        ["Alongside my technology journey, I've also built and managed ", null],
        ['Tag Noida', 'teal'],
        [', giving me real-world experience in content, audience growth, collaborations and building a strong digital community.', null],
      ],
      [
        ['Fenbrix brings all of these experiences together under one vision — to build a technology-driven company that creates meaningful digital solutions for businesses and ambitious people.', null],
      ],
      [
        ['This is more than just a business for me. Fenbrix is something I want to build for the long term — from the first client and first project to a real team, a real workspace and eventually a company that people know and trust.', null],
      ],
      [
        ["I'm still at the beginning of that journey, and I'm ready to put in the work it takes to build it.", null],
      ],
    ],
    expertise: [
      { title: 'Web Development', desc: 'Modern & Scalable Solutions', icon: 'browser', color: 'blue' },
      { title: 'React.js & Technology', desc: 'Frontend Development', icon: 'code', color: 'purple' },
      { title: 'Digital Products', desc: 'Ideas to Real Products', icon: 'box', color: 'emerald' },
      { title: 'Content & Social Media', desc: 'Content Creation & Growth', icon: 'megaphone', color: 'rose' },
      { title: 'Community Building', desc: 'Tag Noida', icon: 'people', color: 'orange' },
      { title: 'AI & Automation', desc: 'Smarter Solutions', icon: 'bot', color: 'cyan' },
    ],
    statement: 'Start small. Build relentlessly. Grow Fenbrix into something bigger.',
  ...
  // Leadership profiles after the first only render as a profile card beside
  // the founder — the section headline, story and expertise come from FOUNDERS[0].
  {
    name: 'Md Ajaz',
    title: 'Head of Business Development',
    highlight: '10+ Years of Business Experience',
    description: 'Bringing 10+ years of experience in business development, client relationships and strategic growth.',
    // Web-sized copy of public/ajaj.png.
    image: '/ajaz-bd.webp',
    portraitTint: true,
  },
];
